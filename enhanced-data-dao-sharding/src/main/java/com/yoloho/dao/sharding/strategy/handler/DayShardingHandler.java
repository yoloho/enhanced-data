package com.yoloho.dao.sharding.strategy.handler;

import org.apache.commons.lang3.time.FastDateFormat;

import com.yoloho.dao.sharding.api.ShardingFactor;
import com.yoloho.dao.sharding.strategy.ShardingContext;
import com.yoloho.dao.sharding.strategy.ShardingHandler;

public class DayShardingHandler implements ShardingHandler{
	...
	public String getShardedTable(ShardingContext context) {
        ...
        return context.getTableModel() + "_" + FastDateFormat.getInstance("yyyyMMdd").format(System.currentTimeMillis());
	}
